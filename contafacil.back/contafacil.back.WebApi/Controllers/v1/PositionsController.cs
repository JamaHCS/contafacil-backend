...
using contafacil.back.Application.Features.Positions.Commands.DeletePositionById;
using contafacil.back.Application.Features.Positions.Commands.UpdatePosition;
using contafacil.back.Application.Features.Positions.Queries.GetPositionById;
...
namespace contafacil.back.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
